...
export default function AnimalBreedsManagementScreen() {
  ...
  const filterBreeds = (breedsList, search, type) => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      Alert.alert('Erreur', error.message || 'Impossible de modifier la race');
    }
  };
      ...
      { text: 'Annuler', onPress: () => {} },
      {
        ...
        onPress: async () => {
          try {
            ...
            Alert.alert('Erreur', error.message || 'Impossible de supprimer la race');
          }
        },
        style: 'destructive',
      },
  ...
  const handleAddNew = async () => {
    ...
    try {
      ...
      Alert.alert('Erreur', error.message || "Impossible d'ajouter la race");
    }
  };
