...
export default function AnimalTypesManagementScreen() {
  ...
  const [filteredTypes, setFilteredTypes] = useState<AnimalType[]>([]);
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      Alert.alert('Erreur', (error as Error).message || 'Impossible de modifier le type');
    }
  };

  const handleDelete = (type: AnimalType) => {
      ...
      { text: 'Annuler', onPress: () => {} },
      {
        ...
        onPress: async () => {
          try {
            ...
            Alert.alert('Erreur', (error as Error).message || 'Impossible de supprimer le type');
          }
        },
        style: 'destructive',
      },
  ...
  const handleAddNew = async () => {
    ...
    try {
      ...
      Alert.alert('Erreur', (error as Error).message || "Impossible d'ajouter le type");
    }
  };
