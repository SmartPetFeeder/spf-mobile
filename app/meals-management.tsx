...
export default function MealsManagementScreen() {
  ...
  const saveEdit = async () => {
    ...
    if (!editingData.quantity || parseInt(editingData.quantity) <= 0) {
    ...
    try {
      ...
      await mealsApi.update(editingId, editingData);
          ...
          <View style={styles.editingContent}>
            ...
            <View style={styles.editingRow}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setEditingData({ ...editingData, quantity: parseInt(text) })
                }
                placeholder="50"
      ...
      <View key={meal.id} style={styles.mealCard}>
        ...
        <View style={styles.mealDetails}>
          ...
          <View style={styles.mealDetailRow}>
            ...
            <Text style={styles.mealDetailValue}>{meal.quantity || meal.amount || '0'}g</Text>
          </View>
          {meal.recurrence && (
            <View style={styles.mealDetailRow}>
              <Text style={styles.mealDetailLabel}>Récurrence :</Text>
              <Text style={styles.mealDetailValue}>{meal.recurrence}</Text>
            </View>
          )}
        </View>
