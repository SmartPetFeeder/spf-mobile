...
export const animalsApi = {
  ...
  update: (id: number, animal: any) => apiCall({ method: 'PUT', endpoint: `/animals/${id}`, body: animal }),
...
export const mealsApi = {
  ...
  update: (id: number, meal: any) => apiCall({ method: 'PUT', endpoint: `/meals/${id}`, body: meal }),
...
export const distributorApi = {
  ...
  create: (distributor: any) => apiCall({ method: 'POST', endpoint: '/distributorStatus', body: distributor }),
  update: (id: number, distributor: any) => apiCall({ method: 'PUT', endpoint: `/distributorStatus/${id}`, body: distributor }),
...
export const statisticsApi = {
  ...
  getByAnimal: (animalId: number) => apiCall({ method: 'GET', endpoint: `/statistics?animalId=${animalId}` }),
};

export const planningApi = {
  getAll: () => apiCall({ method: 'GET', endpoint: '/planning' }),
  update: (planning: any) => apiCall({ method: 'PUT', endpoint: '/planning', body: planning }),
};
